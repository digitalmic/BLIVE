...
import { retrieveAcara, resetAcara, selectKonten } from '../actions';
    ...
    renderItem = (data) => {
        return (
            <TouchableOpacity
                ...
                onPress={() => {
                    this.props.selectKonten(data.item);
                }}>
                <View
                    style={{
                        flex: 1,
...
export default connect(mapStateToProps, { retrieveAcara, resetAcara, selectKonten })(Acara);

...
import { selectInteraktif } from '../actions';
// import * as dataLive from '../data/datalive.json';

const deviceWidth = Dimensions.get('window').width;

class Interaktif extends React.Component {
    ...
    renderInteraktif = (data) => {
        return (
            <TouchableHighlight
                ...
                onPress={() => {
                    this.props.selectInteraktif(data.item);
                }}>
                <ImageBackground
...
export default connect(mapStateToProps, { selectInteraktif })(Interaktif);
...
import { selectDokumentasi } from '../actions';
// import * as dataLive from '../data/datalive.json';
    ...
    renderDokumentasi = (data) => {
        return (
            <TouchableHighlight
                ...
                onPress={() => {
                    this.props.selectDokumentasi(data.item);
                }}>
                <ImageBackground
    ...
    render() {
        return (
            <View style={{ flexDirection: 'row' }}>
                ...
                <FlatList
                    horizontal={true}
                    // ListHeaderComponent={this.renderRegister()}
...
export default connect(mapStateToProps, { selectDokumentasi })(Dokumentasi);